...
if "shards" not in os.listdir("./"):
    corpus_file = "./craft_bionlp_corpus.txt"
    if os.path.exists(corpus_file) == False:
        mega = Mega()
...
#     make shards - comment if already done
    ...
    os.system("split -a 4 -l 2560 -d {} ./shards/shard_".format(corpus_file))
